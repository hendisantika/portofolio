  ...
  >
    <div class="lg:w-1/12">
      <Transition appear name="fadeIn">
        <NuxtLink v-if="!loading" aria-label="YZ." class="home-button" href="/">
          <img
            :src="logo"
            alt="favicon"
            height="40"
    ...
    <div v-if="!loading" class="nav-links">
      <TransitionGroup appear @enter="entering" @before-enter="before">
        <NuxtLink
    ...
    <div class="lg:w-1/12 flex items-center justify-end gap-4">
      <div class="ml-5 flex items-center">
        <button aria-label="theme toggle" type="button" @click="toggleTheme()">
